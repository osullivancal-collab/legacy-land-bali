...
module.exports = [
  ...
  },
  {
    ...
    description: [
      "Kira Tropical Loft is a boutique collection of 22 architect-designed tropical loft residences in Kerobokan, built for smart, comfortable living and genuine investment upside. Each 1-bedroom loft is finished with warm timber detailing, a soaring double-height living space and a private terrazzo plunge pool tucked into its own courtyard.",
      "Upstairs, an open-plan loft bedroom looks down over a sunken living area and dining/kitchen space through a glass-and-timber balustrade — a compact footprint that lives large. Land is 50 m² with 48 m² of building, held on a 30-year leasehold, in a location minutes from Seminyak, Canggu and the beach.",
      "Every loft is fully furnished and ready to rent — king bed, 43\" smart TV, custom kitchen and premium bathroom fittings included — with handover estimated Q1–Q2 2027. Developed by PT. Amory Bali Grup.",
    ],
    features: [
      "1 bedroom, 1 bathroom loft layout",
      "Private terrazzo plunge pool",
      "Double-height living space, sunken living area",
      "Fully furnished — king bed, 43\" smart TV, custom kitchen",
      "Land 50 m² / Building 48 m²",
      "30-year leasehold",
      "Boutique 22-unit development, estimated handover Q1–Q2 2027",
      "Strong rental fundamentals — between Seminyak, Canggu and Petitenget",
      "Minutes to Seminyak, Canggu and the beach",
    ],
    gallery: [
      { src: "/assets/packages/kira-tropical-loft/hero-exterior-dusk.jpg", alt: "Kira Tropical Loft row of tropical lofts at dusk with warm timber-slat facades" },
      { src: "/assets/packages/kira-tropical-loft/section-perspective-cutaway.jpg", alt: "Kira Tropical Loft cross-section — private pool, sunken living, kitchen and loft bedroom" },
      ...
      { src: "/assets/packages/kira-tropical-loft/sunken-living.jpg", alt: "Sunken living area with built-in TV unit and timber staircase" },
      { src: "/assets/packages/kira-tropical-loft/dining-kitchen-evening.jpg", alt: "Dining counter and kitchen in the evening, warm timber finishes" },
      { src: "/assets/packages/kira-tropical-loft/interior-staircase.jpg", alt: "Living area with timber staircase, built-in TV unit and dining counter" },
      { src: "/assets/packages/kira-tropical-loft/bedroom-loft.jpg", alt: "Loft bedroom overlooking the living area through a glass-and-timber balustrade" },
      { src: "/assets/packages/kira-tropical-loft/bathroom.jpg", alt: "Bathroom with granite finishes, rain shower and timber vanity" },
      { src: "/assets/packages/kira-tropical-loft/plunge-pool.jpg", alt: "Private terrazzo plunge pool courtyard" },
      { src: "/assets/packages/kira-tropical-loft/aerial-row-daytime.jpg", alt: "Aerial daytime view of the Kira Tropical Loft row and access driveway" },
      { src: "/assets/packages/kira-tropical-loft/masterplan.jpg", alt: "Kira Tropical Loft masterplan — 22 units of tropical loft" },
    ],
    projectFacts: {
      heading: "22 boutique tropical lofts in Kerobokan",
      text: "A boutique collection of tropical loft residences designed for modern Bali living.",
      facts: [
        { place: "Total Units", time: "22 Tropical Loft Units" },
        { place: "Total Area", time: "1,700 m² (17 Are)" },
        { place: "Ownership", time: "30 Years Leasehold" },
        { place: "Construction Time", time: "12 months — complex finish June 2027" },
        { place: "Estimated Handover", time: "Q1–Q2 2027" },
        { place: "Zoning", time: "Yellow Zone (R-3 Residential)" },
        { place: "Land Size", time: "50 m²" },
        { place: "Building Size", time: "48 m²" },
        { place: "Floors", time: "2-level loft configuration" },
        { place: "Pool", time: "Private plunge pool" },
        { place: "Parking", time: "Central shared parking area" },
      ],
    },
    floorPlan: {
      heading: "1-bedroom loft layout",
      text: "Ground floor: foyer, private pool, dining & kitchen and sunken living. Upstairs: an open loft bedroom, bathroom and storage — 50 m² land, 48 m² building.",
      image: "/assets/packages/kira-tropical-loft/floor-plan.jpg",
    },
    locationSection: {
      heading: "Prime Kerobokan location",
      text: "Positioned between Seminyak, Canggu and Petitenget, Kira sits in a quiet residential pocket of Kerobokan with direct access to Bali's most established lifestyle destinations.",
      distances: [
